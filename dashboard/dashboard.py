...
with st.sidebar:
    ...
    st.markdown(
        f'<div style="display: flex; justify-content: center;"><img src="https://raw.githubusercontent.com/CharlesD12/Analisis_data_E-Commerce_Public_Dataset/main/logo.jpg" width="150"></div>',
...
st.header('Charles Dometian Dashboard :sparkles:')
